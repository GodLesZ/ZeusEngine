...
namespace Zeus.Server.AuthServer.Library {

    public class ZeusAuthServer : ZeusServerBase {

        public ZeusAuthServer(string address)
            : base(address) {
        }

        public ZeusAuthServer(string address, int port)
            : base(address, port) {
        }
