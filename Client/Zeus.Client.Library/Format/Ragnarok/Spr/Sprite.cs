...
using Zeus.Client.Library.Format.Ragnarok.Pal;

namespace Zeus.Client.Library.Format.Ragnarok.Spr {

    public sealed class Sprite : FileFormatBase {
        ...
        public List<SpriteImagePal> ImagesPal { get; protected set; }

        public List<SpriteImageRgba> ImagesRgba { get; protected set; }
        ...
        public char[] MagicHead { get; protected set; }
        ...
        public override string ToString() {
            return string.Format("0x{0}, {1}x pal, {2}x rgba", Version, ImagesPal.Count, ImagesRgba.Count);
        }
        ...
        protected override bool ReadInternal() {
            ...
            // Palette \\
            Reader.BaseStream.Position = (Reader.BaseStream.Length - (4*Palette.ColorCount));
