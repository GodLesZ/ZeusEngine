...
namespace Zeus.CommunicationFramework.Messengers {
    ...
    public class RequestReplyMessenger<TMessenger> : IMessenger, IDisposable where TMessenger : IMessenger {
        ...
        /// </summary>
        private readonly SortedList<ushort, WaitingMessage> _waitingMessages;
        ...
        /// </summary>
        public TMessenger Messenger { get; private set; }
        ...
        /// </summary>
        /// <remarks>
        ///     Response message is matched with RepliedId property, so if
        ...
        public IMessage SendMessageAndWaitForResponse(IMessage message, int timeoutMilliseconds) {
            ...
            lock (_syncObj) {
                _waitingMessages[message.Id] = waitingMessage;
            }
            ...
            try {
                ...
                lock (_syncObj) {
                    if (_waitingMessages.ContainsKey(message.Id)) {
                        _waitingMessages.Remove(message.Id);
                    }
                }
            }
        }
