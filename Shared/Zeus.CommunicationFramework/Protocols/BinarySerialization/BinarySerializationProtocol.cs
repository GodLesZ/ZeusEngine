...
namespace Zeus.CommunicationFramework.Protocols.BinarySerialization {
    ...
    public class BinarySerializationProtocol : IWireProtocol {
        ...
        /// <summary>
        ///     This method is used to serialize a <see cref="IMessage" /> to a byte array.
        ...
        /// <summary>
        ///     This method is used to deserialize a <see cref="IMessage" /> from it's bytes.
        ...
        private bool ReadSingleMessage(ICollection<IMessage> messages) {
            ...
            if (messageLength == 0) {
                // If no more bytes, clear the stream and return immediately
                if (_receiveMemoryStream.Length == 4) {
                    _receiveMemoryStream = new MemoryStream();
                    return false;
                }
