...
namespace Zeus.CommunicationFramework.Services {
    ...
    internal class RemoteInvokeProxy<TProxy, TMessenger> : RealProxy where TMessenger : IMessenger {
        ...
        public override IMessage Invoke(IMessage msg) {
            ...
            var requestMessage = new RemoteInvokeMessage {
                ServiceClassName = typeof(TProxy).Name,
                MethodName = message.MethodName,
                Parameters = message.InArgs
            };

            var responseMessage = _clientMessenger.SendMessageAndWaitForResponse(requestMessage) as RemoteInvokeReturnMessage;
